...
n_hidden_5 = 1*nfeat   # Nodes for the MLP model 
n_hidden_6 = 1*nfeat   # Nodes for the MLP model 
n_hidden_7 = 1*nfeat   # Nodes for the MLP model 
...
#Train_model('Appliances',100000,128)

Train_model('Baby',10000,128)

#Train_model('Home and Kitchen',5000,128)
